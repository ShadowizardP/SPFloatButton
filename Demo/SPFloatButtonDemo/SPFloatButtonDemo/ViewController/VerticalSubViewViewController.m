//
//  VerticalSubViewViewController.m
//  Demo
//
...
@interface VerticalSubViewViewController ()

@end

@implementation VerticalSubViewViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    appDelegate.floatButton.subButtonShowType = SubButtonShowTypeVertical;    //垂直展开优先
