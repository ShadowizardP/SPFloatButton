//
//  DisperseSubViewViewController.m
//  Demo
//
...
@interface DisperseSubViewViewController ()

@end

@implementation DisperseSubViewViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    appDelegate.floatButton.subButtonShowType = SubButtonShowTypeDisperse;    //四散展开
